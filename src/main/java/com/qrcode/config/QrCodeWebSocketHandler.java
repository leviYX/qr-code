...
import com.qrcode.util.JsonUtil;
...
public class QrCodeWebSocketHandler extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        if (msgMap != null && msgMap.containsKey("qrCodeId")) {
            ...
            // 发送确认消息
            var mapText = Map.of("type", "CONNECTED", "message", "Connected to QR code" + qrCodeId);
            var textMessage = new TextMessage(JsonUtil.toJson(mapText));
